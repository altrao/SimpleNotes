...
open class UserNoteRepositoryTest {
    ...
    fun `delete should set deleted to true for given note`() {
        ...
        Assertions.assertEquals(true, updatedUserNote.deleted)
    }
    ...
    fun `delete should not affect other notes`() {
        ...
        Assertions.assertEquals(true, updatedUserNote1.deleted)
        Assertions.assertEquals(false, updatedUserNote2.deleted)
    }
}